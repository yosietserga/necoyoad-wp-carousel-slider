...
if ( ! class_exists( 'Carousel_Slider_Admin' ) ) {
	...
	class Carousel_Slider_Admin {
		...
		public function gallery_url_template() {
			...
			<template id="carouselSliderGalleryUrlTemplate" style="display: none;">
				<div class="carousel_slider-fields">
					<label class="setting">
						<span class="name"><?php esc_html_e( 'URL', 'necoyoad-carousel-slider' ); ?></span>
						<input type="url" name="_images_urls[url][]" value="" autocomplete="off">
					</label>
					<label class="setting">
						<span class="name"><?php esc_html_e( 'Title', 'necoyoad-carousel-slider' ); ?></span>
						<input type="text" name="_images_urls[title][]" value="" autocomplete="off">
					</label>
					<label class="setting">
						<span class="name"><?php esc_html_e( 'Caption', 'necoyoad-carousel-slider' ); ?></span>
						<textarea name="_images_urls[caption][]"></textarea>
					</label>
					<label class="setting">
						<span class="name"><?php esc_html_e( 'Alt Text', 'necoyoad-carousel-slider' ); ?></span>
						<input type="text" name="_images_urls[alt][]" value="" autocomplete="off">
					</label>
					<label class="setting">
						<span class="name"><?php esc_html_e( 'Link To URL', 'necoyoad-carousel-slider' ); ?></span>
		...
		public function carousel_post_type() {
			$labels = array(
				'name'               => _x( 'Slides', 'Post Type General Name', 'necoyoad-carousel-slider' ),
				'singular_name'      => _x( 'Slide', 'Post Type Singular Name', 'necoyoad-carousel-slider' ),
				'menu_name'          => __( 'Carousel Slider', 'necoyoad-carousel-slider' ),
				'parent_item_colon'  => __( 'Parent Slide:', 'necoyoad-carousel-slider' ),
				'all_items'          => __( 'All Slides', 'necoyoad-carousel-slider' ),
				'view_item'          => __( 'View Slide', 'necoyoad-carousel-slider' ),
				'add_new_item'       => __( 'Add New Slide', 'necoyoad-carousel-slider' ),
				'add_new'            => __( 'Add New', 'necoyoad-carousel-slider' ),
				'edit_item'          => __( 'Edit Slide', 'necoyoad-carousel-slider' ),
				'update_item'        => __( 'Update Slide', 'necoyoad-carousel-slider' ),
				'search_items'       => __( 'Search Slide', 'necoyoad-carousel-slider' ),
				'not_found'          => __( 'Not found', 'necoyoad-carousel-slider' ),
				'not_found_in_trash' => __( 'Not found in Trash', 'necoyoad-carousel-slider' ),
			);
			$args   = array(
				'label'               => __( 'Slide', 'necoyoad-carousel-slider' ),
				'description'         => __( 'The easiest way to create carousel slide', 'necoyoad-carousel-slider' ),
				'labels'              => $labels,
		...
		public function post_row_actions( $actions, $post ) {
			...
			$actions['view'] = '<a href="' . $view_url . '" target="_blank">' . esc_html__( 'Preview', 'necoyoad-carousel-slider' ) . '</a>';
		...
		public function columns_head() {
			...
			$columns = array(
				...
				'title'      => __( 'Carousel Slide Title', 'necoyoad-carousel-slider' ),
				'usage'      => __( 'Shortcode', 'necoyoad-carousel-slider' ),
				'slide_type' => __( 'Slide Type', 'necoyoad-carousel-slider' )
			);
		...
		public function add_meta_boxes() {
			add_meta_box(
				"necoyoad-carousel-slider-meta-boxes",
				__( "Carousel Slider", 'necoyoad-carousel-slider' ),
		...
		public function attachment_fields_to_edit( $form_fields, $post ) {
			$form_fields["carousel_slider_link_url"]["label"]      = __( "Link to URL", "necoyoad-carousel-slider" );
