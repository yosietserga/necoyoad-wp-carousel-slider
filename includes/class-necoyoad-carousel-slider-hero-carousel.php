	...
	class Carousel_Slider_Hero_Carousel {
		...
		public function add_slide_template() {
			...
			if ( ! isset( $_POST['post_id'] ) ) {
				$this->send_json( __( 'Required attribute is not set properly.', 'necoyoad-carousel-slider' ), 422 );
			}
			...
			$this->send_json( __( 'Required action is unauthorized.', 'necoyoad-carousel-slider' ), 401 );
		}
