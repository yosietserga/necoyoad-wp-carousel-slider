	...
	class Carousel_Slider_Form {
		...
		public function images_gallery( $args ) {
			...
			$html .= sprintf(
				...
				$value,
				$btn_text,
				esc_html__( 'Create Gallery', 'necoyoad-carousel-slider' ),
				esc_html__( 'Edit Gallery', 'necoyoad-carousel-slider' ),
				esc_html__( 'Save Gallery', 'necoyoad-carousel-slider' ),
				esc_html__( 'Saving...', 'necoyoad-carousel-slider' ),
				esc_html__( 'Insert', 'necoyoad-carousel-slider' )
			);
		...
		public function images_url( array $args ) {
			...
			$btn_text = $value ? __( 'Edit URLs', 'necoyoad-carousel-slider' ) : __( 'Add URLs', 'necoyoad-carousel-slider' );
		...
		public function file( array $args ) {
			...
			echo sprintf( '<input type="button" class="button" id="carousel_slider_video_btn" value="%s">', __( 'Browse', 'necoyoad-carousel-slider' ) );
			echo $this->field_after( $args );
		}
