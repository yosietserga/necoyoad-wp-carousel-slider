...
<div data-id="open" id="section_content_carousel" class="shapla-toggle shapla-toggle--stroke"
    ...
    <span class="shapla-toggle-title">
        <?php esc_html_e( 'Hero Banner Slider', 'necoyoad-carousel-slider' ); ?>
    </span>
    <div class="shapla-toggle-inner">
        <div class="shapla-toggle-content">
            <button class="button necoyoad-carousel-slider__add-slide" data-post-id="<?php echo $post->ID; ?>">Add Slide</button>
					...
					foreach ( $content_sliders as $slide_num => $content_slider ) {
                        ...
                        <div class="shapla-toggle shapla-toggle--normal" data-id="closed">
                            <div class="shapla-toggle-title">
								<?php printf( '%s %s', esc_html__( 'Slide', 'necoyoad-carousel-slider' ), $slide_num + 1 ); ?>
                            </div>
                            <div class="shapla-toggle-inner">
                                <div class="shapla-toggle-content">
                                    ...
                                    <div class="carousel_slider__slide_actions">
										...
										<?php if ( $slide_num !== 0 ): ?>
                                            ...
                                            <button class="button carousel_slider__move_up"
                                                    data-post-id="<?php echo $post->ID; ?>"
                                                    data-slide-pos="<?php echo $slide_num; ?>"
                                                    title="<?php esc_html_e( 'Move Slide Up', 'necoyoad-carousel-slider' ); ?>"
                                            >
                                                <svg class="icon icon-trash" width="20" height="26">
										...
										<?php if ( $slide_num !== ( $total_sliders - 1 ) ): ?>
                                            <button class="button carousel_slider__move_down"
                                                    data-post-id="<?php echo $post->ID; ?>"
                                                    data-slide-pos="<?php echo $slide_num; ?>"
                                                    title="<?php esc_html_e( 'Move Slide Down', 'necoyoad-carousel-slider' ); ?>"
                                            >
                                                <svg class="icon icon-trash" width="20" height="26">
                                    ...
                                    <div class="shapla-section shapla-tabs shapla-tabs--stroke">
                                        <div class="shapla-tab-inner">
                                            ...
                                            <ul class="shapla-nav shapla-clearfix">
                                                <li>
                                                    <a href="#necoyoad-carousel-slider-tab-background"><?php esc_html_e( 'Slide Background',
															'necoyoad-carousel-slider' ); ?></a>
                                                </li>
                                                <li>
                                                    <a href="#necoyoad-carousel-slider-tab-content"><?php esc_html_e( 'Slide Content',
															'necoyoad-carousel-slider' ); ?></a>
                                                </li>
                                                <li>
                                                    <a href="#necoyoad-carousel-slider-tab-link"><?php esc_html_e( 'Slide Link',
															'necoyoad-carousel-slider' ); ?></a>
                                                </li>
                                                <li>
                                                    <a href="#necoyoad-carousel-slider-tab-style"><?php esc_html_e( 'Slide Style',
															'necoyoad-carousel-slider' ); ?></a>
                                                </li>
                                            </ul>
            ...
            <div class="content_settings">
				...
				<?php
				$animations = [
					''            => esc_html__( 'None', 'necoyoad-carousel-slider' ),
					'fadeInDown'  => esc_html__( 'Fade In Down', 'necoyoad-carousel-slider' ),
					'fadeInUp'    => esc_html__( 'Fade In Up', 'necoyoad-carousel-slider' ),
					'fadeInRight' => esc_html__( 'Fade In Right', 'necoyoad-carousel-slider' ),
					'fadeInLeft'  => esc_html__( 'Fade In Left', 'necoyoad-carousel-slider' ),
					'zoomIn'      => esc_html__( 'Zoom In', 'necoyoad-carousel-slider' ),
				];
				?>
