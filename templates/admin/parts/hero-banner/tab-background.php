...
?>
<div id="necoyoad-carousel-slider-tab-background" class="shapla-tab tab-background">
        ...
        <div class="slide-media-left">
            <div class="slide_thumb">
                ...
                <span class="delete-bg-img<?php echo ! $_have_img ? ' hidden' : ''; ?>"
                      title="<?php esc_html_e( 'Delete the background image for this slide', 'necoyoad-carousel-slider' ); ?>">&times;</span>
            </div>
        </div>
        <div class="slide-media-right">
            ...
            <div class="slide_image_settings_line">
                <a href="<?php echo esc_url( $upload_link ); ?>"
                   data-title="<?php esc_html_e( 'Select or Upload Slide Background Image', 'necoyoad-carousel-slider' ); ?>"
                   data-button-text="<?php esc_html_e( 'Set Background Image', 'necoyoad-carousel-slider' ); ?>"
                   class="button slide_image_add"><?php esc_html_e( 'Set Background Image', 'necoyoad-carousel-slider' ); ?></a>
            ...
            <div class="slide_image_settings_line">
                <span><?php esc_html_e( 'Background Position:', 'necoyoad-carousel-slider' ); ?></span>
            ...
            <div class="slide_image_settings_line">
                <span><?php esc_html_e( 'Background Size:', 'necoyoad-carousel-slider' ); ?></span>
            ...
            <div class="slide_image_settings_line">
                <span><?php esc_html_e( 'Ken Burns Effect:', 'necoyoad-carousel-slider' ); ?></span>
                <select class="background_image_size"
            ...
            <div class="slide_image_settings_line">
                <span><?php esc_html_e( 'Background Color:', 'necoyoad-carousel-slider' ); ?></span>
            ...
            <div class="slide_image_settings_line">
                <span><?php esc_html_e( 'Background Overlay:', 'necoyoad-carousel-slider' ); ?></span>
