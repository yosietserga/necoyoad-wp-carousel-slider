...
<div data-id="closed" id="content_carousel_button_one" class="shapla-toggle shapla-toggle--stroke">
	<span class="shapla-toggle-title">
		<?php esc_html_e( 'Button #1', 'necoyoad-carousel-slider' ); ?>
	</span>
        ...
        <div class="shapla-toggle-content">
            ...
            <div class="sp-input-group" id="field-button_one_text">
                <div class="sp-input-label">
                    <label for="button_one_text"><?php esc_html_e( 'Button Text', 'necoyoad-carousel-slider' ); ?></label>
            ...
            <div class="sp-input-group" id="field-button_one_url">
                <div class="sp-input-label">
                    <label for="button_one_url"><?php esc_html_e( 'Button URL', 'necoyoad-carousel-slider' ); ?></label>
            ...
            <div class="sp-input-group" id="field-button_one_target">
                <div class="sp-input-label">
                    <label for="button_one_target"><?php esc_html_e( 'Open Button Link In', 'necoyoad-carousel-slider' ); ?></label>
                </div>
                <div class="sp-input-field">
                    <select name="carousel_slider_content[<?php echo $slide_num; ?>][button_one_target]"
                            id="button_one_target" class="sp-input-text">
                        <option value="_blank" <?php selected( $_btn_1_target, '_blank' ); ?>><?php esc_html_e( 'New Window', 'necoyoad-carousel-slider' ); ?></option>
                        <option value="_self" <?php selected( $_btn_1_target, '_self' ); ?>><?php esc_html_e( 'Same window', 'necoyoad-carousel-slider' ); ?></option>
                    </select>
                </div>
            ...
            <div class="sp-input-group" id="field-button_one_target">
                <div class="sp-input-label">
                    <label for="button_one_type"><?php esc_html_e( 'Button Type', 'necoyoad-carousel-slider' ); ?></label>
                </div>
                <div class="sp-input-field">
                    <select name="carousel_slider_content[<?php echo $slide_num; ?>][button_one_type]"
                            id="button_one_target" class="sp-input-text">
                        <option value="normal" <?php selected( $_btn_1_type, 'normal' ); ?>><?php esc_html_e( 'Normal', 'necoyoad-carousel-slider' ); ?></option>
                        <option value="stroke" <?php selected( $_btn_1_type, 'stroke' ); ?>><?php esc_html_e( 'Stroke', 'necoyoad-carousel-slider' ); ?></option>
                    </select>
                </div>
            </div><!-- Button Type -->
            ...
            <div class="sp-input-group" id="field-button_one_size">
                <div class="sp-input-label">
                    <label for="button_one_type"><?php esc_html_e( 'Button Size', 'necoyoad-carousel-slider' ); ?></label>
                </div>
                <div class="sp-input-field">
                    <select name="carousel_slider_content[<?php echo $slide_num; ?>][button_one_size]"
                            id="button_one_size" class="sp-input-text">
                        <option value="large" <?php selected( $_btn_1_size, 'large' ); ?>><?php esc_html_e( 'Large', 'necoyoad-carousel-slider' ); ?></option>
                        <option value="medium" <?php selected( $_btn_1_size, 'medium' ); ?>><?php esc_html_e( 'Medium', 'necoyoad-carousel-slider' ); ?></option>
                        <option value="small" <?php selected( $_btn_1_size, 'small' ); ?>><?php esc_html_e( 'Small', 'necoyoad-carousel-slider' ); ?></option>
                    </select>
                </div>
            </div><!-- Button Size -->
            ...
            <div class="sp-input-group" id="field-button_one_border_width">
                <div class="sp-input-label">
                    <label for="button_one_border_width"><?php esc_html_e( 'Border Width', 'necoyoad-carousel-slider' ); ?></label>
            ...
            <div class="sp-input-group" id="field-button_one_border_radius">
                <div class="sp-input-label">
                    <label for="button_one_border_radius"><?php esc_html_e( 'Border Radius', 'necoyoad-carousel-slider' ); ?></label>
            ...
            <div class="sp-input-group" id="field-button_one_bg_color">
                <div class="sp-input-label">
                    <label for="button_one_bg_color"><?php esc_html_e( 'Button Color', 'necoyoad-carousel-slider' ); ?></label>
                </div>
                <div class="sp-input-field">
            ...
            <div class="sp-input-group" id="field-button_one_color">
                <div class="sp-input-label">
                    <label for="button_one_color"><?php esc_html_e( 'Button Text Color', 'necoyoad-carousel-slider' ); ?></label>
                </div>
                <div class="sp-input-field">
