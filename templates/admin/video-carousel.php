...
<div data-id="open" id="section_video_settings" class="shapla-toggle shapla-toggle--stroke"
	...
	<span class="shapla-toggle-title">
		<?php esc_html_e( 'Video Settings', 'necoyoad-carousel-slider' ); ?>
	</span>
    <div class="shapla-toggle-inner">
        <div class="shapla-toggle-content">
			...
			$this->form->textarea( array(
				'id'   => '_video_url',
				'name' => esc_html__( 'Video URLs', 'necoyoad-carousel-slider' ),
				'desc' => sprintf(
					'%s<br><br>Example: %s',
					esc_html__( 'Only support youtube and vimeo. Enter video URL from youtube or vimeo separating each by comma', 'necoyoad-carousel-slider' ),
