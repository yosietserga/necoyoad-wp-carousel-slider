...
?>
<div class="necoyoad-carousel-slider-outer necoyoad-carousel-slider-outer-images necoyoad-carousel-slider-outer-<?php echo $id; ?>">
	...
	<div <?php echo join( " ", $this->carousel_options( $id ) ); ?>>
		...
		foreach ( $images_ids as $image_id ):
			...
			echo '<div class="necoyoad-carousel-slider__item">';
			...
			if ( $_show_attachment_title == 'on' && $_show_attachment_caption == 'on' ) {
				...
				$full_caption = sprintf( '<div class="necoyoad-carousel-slider__caption">%1$s%2$s</div>', $title, $caption );

			} elseif ( $_show_attachment_title == 'on' ) {

				$full_caption = sprintf( '<div class="necoyoad-carousel-slider__caption">%s</div>', $title );

			} elseif ( $_show_attachment_caption == 'on' ) {

				$full_caption = sprintf( '<div class="necoyoad-carousel-slider__caption">%s</div>', $caption );
