...
if ( ! carousel_slider_is_woocommerce_active() ) {
	if ( current_user_can( 'manage_options' ) ) {
		printf(
			esc_html__( 'Carousel Slider needs %s to work for products carousel.', 'necoyoad-carousel-slider' ),
			sprintf( '<a href="https://wordpress.org/plugins/woocommerce/" target="_blank" >%s</a>',
				__( 'WooCommerce', 'necoyoad-carousel-slider' )
			)
		);
	}
...
?>
<div class="products necoyoad-carousel-slider-outer necoyoad-carousel-slider-outer-products necoyoad-carousel-slider-outer-<?php echo $id; ?>">
    ...
    <div <?php echo join( " ", $this->carousel_options( $id ) ); ?>>
		...
		foreach ( $posts as $post ):
			...
			echo '<div class="product necoyoad-carousel-slider__product">';
