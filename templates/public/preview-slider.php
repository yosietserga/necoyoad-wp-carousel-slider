...
<head>
    ...
    <style type="text/css" media="screen">
        ...
        * html body {
        ...
        .necoyoad-carousel-slider-preview-container {
            max-width: 1024px;
            margin-left: auto;
            margin-right: auto;
        }
...
<body>
<div class="necoyoad-carousel-slider-preview-container">
...
<script type="text/javascript">
    jQuery(document).ready(function () {
        setTimeout(function () {
            ...
            var height = jQuery('.necoyoad-carousel-slider-preview-container').outerHeight(true);
