 ...
 * WC tested up to: 5.4
 *
 * Text Domain: necoyoad-necoyoad-carousel-slider
 *
 * License: GPLv3
...
if ( ! class_exists( 'Carousel_Slider' ) ) {
	...
	final class Carousel_Slider {
		 ...
		 * @var string
		 */
		private $plugin_name = 'necoyoad-carousel-slider';
		...
		public function php_version_notice() {
			...
			$error = __( 'Your installed PHP Version is: ', 'necoyoad-carousel-slider' ) . PHP_VERSION . '. ';
			$error .= sprintf( __( 'The Carousel Slider plugin requires PHP version %s or greater.',
				'necoyoad-carousel-slider' ), $this->min_php );
			?>
			<div class="error">
		...
		public function auto_deactivate() {
			...
			$error = '<h1>' . __( 'An Error Occurred', 'necoyoad-carousel-slider' ) . '</h1>';
			$error .= '<h2>' . __( 'Your installed PHP Version is: ', 'necoyoad-carousel-slider' ) . PHP_VERSION . '</h2>';
			$error .= '<p>' . sprintf( __( 'The Carousel Slider plugin requires PHP version %s or greater',
					'necoyoad-carousel-slider' ), $this->min_php ) . '</p>';
			...
			wp_die( $error, __( 'Plugin Activation Error', 'necoyoad-carousel-slider' ), array( 'back_link' => true ) );
		}
