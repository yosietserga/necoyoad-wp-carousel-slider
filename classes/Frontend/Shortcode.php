...
class Shortcode {
	...
	private function carousel_options( $id ) {
		...
		$class = 'owl-carousel necoyoad-carousel-slider';
	...
	private function product_categories( $id = 0 ) {
		...
		if ( $product_categories ) {
			echo '<div class="necoyoad-carousel-slider-outer necoyoad-carousel-slider-outer-products necoyoad-carousel-slider-outer-' . $id . '">';
